 ...
 * @author Rembao
 */
@WebServlet(name = "VendedorListaJSON", urlPatterns = {"/pv/admon/VendedorListaJSON"})
public class VendedorListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = vendedor.getListaVendedor(draw);
                out.print(json.toJSONString());
                
               
            } catch (SqlAppsException ex) {
                Logger.getLogger(VendedorListaJSON.class.getName()).log(Level.SEVERE, null, ex);
            }
