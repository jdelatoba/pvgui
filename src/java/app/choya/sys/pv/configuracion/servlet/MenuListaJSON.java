 ...
 * @author Rembao
 */
@WebServlet(name = "MenuListaJSON", urlPatterns = {"/admon/MenuListaJSON.pv"})
public class MenuListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = menu.getListaMenuJSON(draw);
