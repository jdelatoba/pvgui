 ...
 * @author Rembao
 */
@WebServlet(name = "ImpuestoListaJSON", urlPatterns = {"/pv/admon/ImpuestoListaJSON"})
public class ImpuestoListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = impuesto.getImpuestoJSON(draw);
                out.print(json.toJSONString());
                
               
            } catch (SqlAppsException ex) {
                Logger.getLogger(ImpuestoListaJSON.class.getName()).log(Level.SEVERE, null, ex);
            }
