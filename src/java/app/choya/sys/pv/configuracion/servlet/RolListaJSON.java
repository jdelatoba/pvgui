...
import app.choya.sys.pv.configuracion.Rol;
import app.choya.sys.pv.catalogo.servlet.ProveedorListaJSON;
 ...
 * @author Rembao
 */
@WebServlet(name = "RolListaJSON", urlPatterns = {"/pv/admon/RolListaJSON"})
public class RolListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = rol.getRolJSON(draw);
