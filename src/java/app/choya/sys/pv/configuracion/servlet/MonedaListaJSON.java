 ...
 * @author Rembao
 */
@WebServlet(name = "MonedaListaJSON", urlPatterns = {"/pv/admon/MonedaListaJSON"})
public class MonedaListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = moneda.getMonedaJSON(draw);
                out.print(json.toJSONString());
                
               
            } catch (SqlAppsException ex) {
                Logger.getLogger(MonedaListaJSON.class.getName()).log(Level.SEVERE, null, ex);
            }
