 ...
 * @author Rembao
 */
@WebServlet(name = "UsuarioListaJSON", urlPatterns = {"/admon/UsuarioListaJSON.pv"})
public class UsuarioListaJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                JSONObject json = usuario.getUsuarioJSON(draw);
