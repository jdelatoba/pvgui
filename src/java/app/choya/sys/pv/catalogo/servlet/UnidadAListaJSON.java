...
import app.choya.sys.pv.configuracion.servlet.UnidadController;
 ...
 * @author Rembao
 */
@WebServlet(name = "UnidadAListaJSON", urlPatterns = {"/pv/UnidadAListaJSON"})
public class UnidadAListaJSON extends HttpServlet {
