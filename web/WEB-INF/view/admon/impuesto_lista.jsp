<%-- 
    Document   : impuesto_lista
    Created on : 28-mar-2017, 13:26:18
    Author     : Rembao
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#tabla_impuestos').DataTable( {
        "processing": true,
            //"serverSide": true,
            "ajax": {
               url:  "../pv/admon/ImpuestoListaJSON",
               type: "POST"
            },
            "scrollY":        400,
            "scrollCollapse": true,
    ...
    $('#tabla_impuestos tbody').on( 'click', 'tr', function () {
        ...
        $("#agregar").click(function(e){
           ...
           $('#form_tabla_impuesto').attr('action', "../pv/Hub");
           $("#form_tabla_impuesto").submit();
        ...
        $("#aceptar_comando").click(function(e){
            ...
            if($("#operacion").val() == "editar"){
                ...
                $("#funcion_forma").val("editar_impuesto");
                $('#form_tabla_impuesto').attr('action', "../pv/Hub");
                $("#form_tabla_impuesto").submit();
            }
...
<form class="form-horizontal" method="post" id="form_tabla_impuesto" name="form_tabla_impuesto">
<div class="row">
...
<div class="row">
    <div class="col-xs-12">
        <table id="tabla_impuestos" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
