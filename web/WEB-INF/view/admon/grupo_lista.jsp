<%-- 
    Document   : grupo_lista
    Created on : 12-mar-2017, 14:05:54
    Author     : Rembao
--%>

<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="gbean" class="app.choya.sys.pv.configuracion.VendedorGrp"  />
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#tabla_grupo_vendedor').DataTable( {
        "processing": true,
            //"serverSide": true,
            "ajax": {
               url:  "../pv/admon/VendedorGrpListaJSON",
               type: "POST"
            },
            "scrollY":        400,
            "scrollCollapse": true,
    ...
    $('#tabla_grupo_vendedor tbody').on( 'click', 'tr', function () {
    ...
    $('#tabla_grupo_vendedor tbody').on( 'click', '#seleccionar', function () {
        ...
        var $grupo = $(this).closest("tr")   // busca el row mas cercano <tr> 
                       .find(".vendedor-grupo")     // busca la class = "rol"
                       .text(); // saca el valor del texto de la columna       
        ...
        $('#tabla_grupo_vendedor tbody').on( 'click', '#eliminar', function () {
            var $item = $(this).closest("tr")   // busca el row mas cercano <tr> 
                           .find(".id-control")     // busca la class = "id-control"
                           .text(); // saca el valor del texto de la columna
...
<div class="row">
    <div class="col-xs-12">
        <table id="tabla_grupo_vendedor" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>No.</th>
                <th>Grupo</th>
