<%-- 
    Document   : usuario
    Created on : 10-mar-2017, 19:28:54
    Author     : Rembao
--%>
        ...
        <div class="panel-body">
                ...
                <div class="row">
                 ...
                 <div class="row">   
                    <div class="col-xs-12">
                        <div class="form-group">
                            <div class="col-md-12 col-lg-2">
                                <label for="usuario" class="form-control-label">Usuario<label style="color: red">*</label></label>
                            </div>
                            <div class="col-md-12 col-lg-10">
                                <div class="controls form-inline">
                                    <input type="text" class="form-control" id="usuario" name="usuario" value="${usuario}" placeholder="" size="30" maxlength="50" />
                ...
                <div class="row">    
                    <div class="col-xs-12">
                        <div class="form-group">
                            <div class="col-md-12 col-lg-2">
                                <label for="password" class="form-control-label">Contraseña<label style="color: red">*</label></label>
                            </div>
                            <div class="col-md-12 col-lg-10">
                                <div class="controls form-inline">
                ...
                <div class="row">                    
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label for="repassword" class="col-md-12 col-lg-2">Confirmar<label style="color: red">*</label></label>
                            <div class="col-md-12 col-lg-10">
                                <div class="controls form-inline">
               ...
               <div class="row">    
                ...
                <div class="row">    
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label for="vendedor" class="col-md-12 col-lg-2">Vendedor<label style="color: red">*</label></label>
                            <div class="col-md-12 col-lg-10">
                                <div class="controls form-inline">
                                    <div class="input-group">
