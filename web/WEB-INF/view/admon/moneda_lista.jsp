<%-- 
    Document   : moneda_lista
    Created on : 30-mar-2017, 11:55:37
    Author     : Rembao
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('#tabla_monedas').DataTable( {
        "processing": true,
            //"serverSide": true,
            "ajax": {
               url:  "../pv/admon/MonedaListaJSON",
               type: "POST"
            },
            "scrollY":        400,
            "scrollCollapse": true,
    ...
    $('#tabla_monedas tbody').on( 'click', 'tr', function () {
        ...
        $("#agregar").click(function(e){
           $("#funcion_forma").val("monedas");
           $('#form_tabla_moneda').attr('action', "../pv/Hub");
           $("#form_tabla_moneda").submit();
        ...
        $("#aceptar_comando").click(function(e){
            ...
            if($("#operacion").val() == "editar"){
                ...
                $("#funcion_forma").val("editar_moneda");
                $('#form_tabla_moneda').attr('action', "../pv/Hub");
                $("#form_tabla_moneda").submit();
            }
...
<form class="form-horizontal" method="post" id="form_tabla_moneda" name="form_tabla_moneda">
<div class="row">
...
<div class="row">
    <div class="col-xs-12">
        <table id="tabla_monedas" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
