<%-- 
    Document   : vendedor_lista
    Created on : 13-mar-2017, 9:10:02
    Author     : Rembao
--%>
...
<script type="text/javascript">
    ...
    $('#tabla_vendedores tbody').on( 'click', 'tr', function () {
        ...
        $("#agregar").click(function(e){
           ...
           $('#form_tabla_vendedor').attr('action', "../pv/Hub");
           $("#form_tabla_vendedor").submit();
        ...
        $("#aceptar_comando").click(function(e){
            ...
            if($("#operacion").val() == "editar"){
                ...
                $("#funcion_forma").val("editar_vendedor");
                $('#form_tabla_vendedor').attr('action', "../pv/Hub");
                $("#form_tabla_vendedor").submit();
            }
...
<form class="form-horizontal" method="post" id="form_tabla_vendedor" name="form_tabla_vendedor">
<div class="row">
