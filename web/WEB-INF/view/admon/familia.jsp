...
<jsp:useBean id="familia" class="app.choya.sys.pv.configuracion.Familia"  />
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $("#form_familia").validate({
            ...
            messages: {
                descripcion: {
                    required: "&nbsp;Por favor introduzca una descripcion para el familia",
            ...
            submitHandler: function (form) {
                ...
                $.post("../admon/familiaController", formData, function (data) {
...
<style type="text/css">
 ...
 hr {
  ...
  margin: 18px 20px 18px 0px;
    ...
    <c:choose>
         <c:when test="${requestScope.familia_id != null &&  requestScope.familia_id != 0}">
            <c:forEach var="ebean" items="${familia.getfamilia()}" >
...
<form class="form-horizontal" method="post" id="form_familia" name="form_familia">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Catalogo de familias</div>
