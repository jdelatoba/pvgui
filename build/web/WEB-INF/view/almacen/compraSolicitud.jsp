                 ...
                 <div class="row">                    
                            <div class="col-xs-12 col-lg-6">
                                <div class="form-group">
                                    <label for="representante" class="col-md-12 col-lg-3">Proveedor</label>
                     ...
                     <div class="row">                    
                            <div class="col-xs-12 col-lg-6">
                                <div class="form-group">
                                    <label for="representante" class="col-md-12 col-lg-3">Articulo</label>
                                    <div class="col-md-12 col-lg-9">
                                        <div class="controls form-inline">
                            ...
                            <div class="col-xs-12 col-lg-6">
                                <div class="form-group">
                                    <label for="nombre" class="col-md-12 col-lg-3">Cantidad<label style="color: red">*</label></label>
                                    <div class="col-md-12 col-lg-9">
                                        <div class="controls form-inline">
                                            <input type="text" class="form-control" id="nombre" name="nombre" value="" placeholder="" size="15" maxlength="250" />
